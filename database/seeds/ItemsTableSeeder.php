...
bourguignon pot au feu (12.5€/kg)',
      ...
      $items[] = array(
          ...
          'comment'     => 'Colis de 15 kgs ou 7,5 kgs environ composés de morceaux de viande de boeuf panachés.
...
La traçabilité est assurée par l\'étiquette qui précise le type de morceau, le poids et l\'origine de la viande. 16€/kg',
      ...
      $items[] = array(
          ...
          'comment'     => 'pommes de terre Bintje bio parfaites pour les purées, les frites et les potages. conditionné en sacs de 2.5 kg, 5 kg et 10 kg. 11€ pour 10kg',
          'created_at'  => $date->format('Y-m-d H:i:s')
      );

      $items[] = array(
          // 'name'        => 'Pommes de terre bio variété esmeralda',
          'comment'     => 'pommes de terre variété esmeralda à chaire ferme, idéal à la vapeur, sautées. 13€ pour 10kg',
          'created_at'  => $date->format('Y-m-d H:i:s')
      );
      ...
      $items[] = array(
          ...
          'comment'     => 'Toute l\'année, des bons escargots en coquille !',
          'created_at'  => $date->format('Y-m-d H:i:s')
      );
